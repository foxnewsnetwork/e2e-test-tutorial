...
define('dummy/tests/app.lint-test', [], function () {
  ...
  QUnit.test('models/guide.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/guide.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/guides.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/guides.js should pass ESLint\n\n');
  });

  QUnit.test('routes/guides/guide.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/guides/guide.js should pass ESLint\n\n');
  });

  QUnit.test('routes/guides/table-of-contents.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/guides/table-of-contents.js should pass ESLint\n\n');
  });
});
